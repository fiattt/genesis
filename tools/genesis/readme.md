**IMPORTANT: Genesis block generation that includes initial accounts and block producers is deprecated in DAWN 3.X and higher. This is only relevant if using DAWN 2.X public testnet!!!!**
